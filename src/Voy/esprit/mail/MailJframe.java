...
public class MailJframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("envoyer une reclamation");
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 30, 290, 200));
    ...
    private void jButtonSendMailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSendMailActionPerformed
        ...
        if(jLabelpieceJointe.getText()==""){
        mc.getMailMessage2(mail);
        mc.SendMessage();}
        if(jLabelpieceJointe.getText()!=""){ String s = this.cleanUrl(url);
   ...
   int row = jTable1.getSelectedRow();
        ...
        Object idclient = jTable1.getValueAt(row, 0);
 ...
 jTextMailAddressReceiver.setText(""+e);
